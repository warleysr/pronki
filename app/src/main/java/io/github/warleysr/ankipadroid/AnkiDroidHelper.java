                ...
                if (!cards.isEmpty()) {
                    for (CardInfo card : cards) {
                        ...
                        if (specificCardCursor == null || !specificCardCursor.moveToFirst()) {
                            ...
                            card.question = specificCardCursor.getString(specificCardCursor.getColumnIndex(FlashCardsContract.Card.QUESTION_SIMPLE));
                            card.answer = specificCardCursor.getString(specificCardCursor.getColumnIndex(FlashCardsContract.Card.ANSWER_PURE));
                            specificCardCursor.close();
                        }
                    }
                    return cards.get(0);
